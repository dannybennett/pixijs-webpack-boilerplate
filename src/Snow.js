...
// https://codepen.io/jh3y/pen/VdMBaR
export const addSnow = (app) => {
    ...
    const getRandomColor = () => [0xf22613, 0xf9690e, 0xf9bf3b, 0x2ecc71, 0x19b5fe, 0x663399, 0x947cb0][Math.floor(Math.random() * 7)];
